...
function ModuleCard({
  ...
  return (
    <Link
      href={href}
      prefetch
      className={`group relative flex h-full min-h-[164px] flex-col justify-between overflow-hidden rounded-[28px] border border-white/70 p-4 shadow-[0_14px_34px_rgba(91,54,35,0.08)] transition-all duration-200 ease-out hover:-translate-y-0.5 hover:scale-[1.02] hover:shadow-[0_20px_46px_rgba(91,54,35,0.14)] active:scale-[0.985] ${tintClass}`}
    >
      <div className="pointer-events-none absolute inset-x-6 top-0 h-20 rounded-full bg-white/30 blur-2xl transition-transform duration-200 group-hover:translate-y-1" />
      <div className="relative flex items-start justify-between gap-3">
        <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full border border-white/70 bg-white/75 text-wine shadow-[inset_0_1px_0_rgba(255,255,255,0.9)] backdrop-blur-sm">
          {icon}
        </div>
        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-white/70 text-wine/70 transition-all duration-200 group-hover:bg-white/90 group-hover:text-wine group-hover:translate-x-0.5">
...
export default async function HomePage() {
  ...
  return (
    <div className="flex w-full min-w-0 flex-col gap-10 overflow-x-hidden pb-6">
      {daily.questionId ? (
        <section className="relative mt-6 w-full overflow-hidden rounded-[32px] border border-white/65 bg-[linear-gradient(135deg,rgba(124,39,54,0.12),rgba(255,255,255,0.78)_40%,rgba(244,225,212,0.82))] px-5 py-6 shadow-[0_22px_48px_rgba(91,54,35,0.12)] backdrop-blur-sm">
          ...
          <div className="relative flex flex-col gap-5">
            <div className="flex min-w-0 items-start justify-between gap-3">
              ...
              <DailyQuestionCta
                ...
                className="quiz-fab shrink-0 rounded-2xl bg-primary px-4 py-3 text-sm font-semibold text-primary-foreground shadow-[0_16px_36px_rgba(124,39,54,0.24)] transition-all duration-200 ease-out hover:-translate-y-0.5 hover:bg-wine-dark active:scale-[0.985]"
              />
            </div>
            <p className="max-w-[32rem] font-heading text-[25px] font-semibold leading-snug tracking-tight text-foreground">
              {daily.prompt}
            </p>
          </div>
        </section>
      ...
      <section className="mt-8 flex w-full min-w-0 flex-col gap-4">
        <h2 className="font-heading text-[1.55rem] font-semibold tracking-tight text-foreground">
          {quizSectionTitle}
        </h2>
        <ul className="flex w-full min-w-0 list-none flex-col gap-3 p-0">
          <li>
            <DailyQuestionCta
              ...
              authCopy={dailyQuestionAuthCopy}
              className="group flex h-12 w-full min-w-0 max-w-full flex-1 items-center justify-between gap-3 rounded-full border border-primary/20 bg-primary px-4 text-sm font-semibold text-primary-foreground shadow-[0_14px_30px_rgba(124,39,54,0.22)] transition-colors duration-200 ease-out active:opacity-90 hover:bg-wine-dark"
            >
          ...
          {quizPills.map((pill) => (
            <li key={pill.href}>
              <DailyQuestionCta
                ...
                label={pill.label}
                authCopy={dailyQuestionAuthCopy}
                className="group flex h-12 w-full min-w-0 max-w-full flex-1 items-center justify-between gap-3 rounded-full border border-white/70 bg-white/75 px-4 text-sm font-semibold text-foreground shadow-[0_10px_26px_rgba(91,54,35,0.08)] backdrop-blur-sm transition-colors duration-200 ease-out active:opacity-90 hover:border-primary/15 hover:bg-white"
              >
                <span className="flex min-w-0 flex-1 items-center gap-3">
                  <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-accent/80 text-wine">
                    {pill.icon}
                  </span>
              ...
              if (item.type === "grape") {
                ...
                return (
                  <div
                    ...
                    className="shrink-0 w-[10.5rem] rounded-[26px] border border-white/70 bg-white/78 p-4 shadow-[0_12px_28px_rgba(91,54,35,0.08)] backdrop-blur-sm transition-all duration-200 ease-out hover:-translate-y-0.5 hover:scale-[1.02] hover:bg-white hover:shadow-[0_18px_38px_rgba(91,54,35,0.14)] active:scale-[0.985]"
                  >
                    <div className="flex items-start justify-between gap-2">
                      <div className="min-w-0">
                        <Link
                          ...
                          aria-label={name}
                        >
                        <div className="font-heading text-base font-semibold leading-tight truncate">
                            {name}
                          </div>
                        </Link>
      ...
      <section className="flex w-full min-w-0 flex-col gap-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <Link
            ...
            prefetch
            className="group relative flex min-h-[138px] flex-col justify-between overflow-hidden rounded-[28px] border border-white/70 bg-[linear-gradient(180deg,rgba(255,240,237,0.98),rgba(255,252,250,0.96))] p-4 shadow-[0_14px_34px_rgba(91,54,35,0.08)] transition-all duration-200 ease-out hover:-translate-y-0.5 hover:scale-[1.02] hover:shadow-[0_20px_46px_rgba(91,54,35,0.14)] active:scale-[0.985]"
            aria-label="AOP"
          >
            <div className="pointer-events-none absolute inset-x-6 top-0 h-16 rounded-full bg-white/30 blur-2xl" />
            <div className="relative flex items-start justify-between gap-3">
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-white/70 bg-white/75 text-wine">
          ...
          <Link
            href="/cepages"
            prefetch
            className="group relative flex min-h-[138px] flex-col justify-between overflow-hidden rounded-[28px] border border-white/70 bg-[linear-gradient(180deg,rgba(245,239,255,0.98),rgba(255,252,255,0.96))] p-4 shadow-[0_14px_34px_rgba(91,54,35,0.08)] transition-all duration-200 ease-out hover:-translate-y-0.5 hover:scale-[1.02] hover:shadow-[0_20px_46px_rgba(91,54,35,0.14)] active:scale-[0.985]"

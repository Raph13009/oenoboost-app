...
export type ToggleDictionaryFavoriteResult =
...
export async function toggleDictionaryFavoriteAction(
  termId: string,
): Promise<ToggleDictionaryFavoriteResult> {

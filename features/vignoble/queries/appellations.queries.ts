...
const AOP_COLUMNS =
  "id, slug, name, area_hectares, producer_count, production_volume_hl, price_range_min_eur, price_range_max_eur, history_fr, history_en, colors_grapes_fr, colors_grapes_en, soils_description_fr, soils_description_en, is_grand_cru, is_premium, status, created_at, updated_at, deleted_at, published_at";
